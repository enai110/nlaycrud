...
<body>
    ...
    <form action="delete/search_delete.php" method="get" class="form-delete">
        <div class="mt-30">
            <input id="nama_lengkap" class="input-delete" type="text" name="keyword" placeholder="Masukan ID" />
        </div>
        ...
        <table border="1" class="table">
            <thead class="table-header">
                <tr>
                    ...
                    <th style="text-align:center">ID_siswa</th>
            ...
            <?php
                ...
                <tr>
                    ...
                    <th align="center"> <?= $data['id_siswa'] ?> </td>
